...
const WithdrawAmount = () => {
  ...
  return (
    ...
    >
      ...
      <input
        className="p-6 w-[100%] rounded-xl bg-[#2F2F36] outline-none text-white mb-2"
        type="text"
      ...
      <button
        ...
        type="submit"
        className="text-gray-200 bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 shadow-lg shadow-pink-500/50 dark:shadow-lg dark:shadow-pink-800/80 font-medium rounded-lg text-m px-5 py-5 text-center me-2 mb-2 w-[100%] mt-6 uppercase"
      >
        UnStake Token
      </button>
    </form>
